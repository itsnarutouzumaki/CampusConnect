...
const AdminProfile = () => {
  ...
  return (
    <div className="w-full">
      <div className="w-fit mx-auto my-9 px-4 md:px-20 py-2 md:bg-white/20 backdrop-blur-[10%] grid md:grid-cols-3 justify-evenly shadow-md rounded-lg md:border hover:shadow-lg transition-shadow duration-100 relative">
        {/* Edit Icon in Circle */}
        <div
