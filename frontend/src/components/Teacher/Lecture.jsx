...
const LectureBar = ({ lecture }) => {
  const { lectureId,lectureName, lectureLink, hours, minutes, time, date } = lecture;
  return (
    <div
    ...
    >
      <p className="text-xl flex flex-col italic text-white font-sans">
        <a href={lectureLink} className="text-white no-underline" target="_blank" rel="noopener noreferrer">
          {lectureName}
        </a>
