  ...
  return (
    <div className="w-full">
      <div className="w-full mx-auto mt-3 px-4 md:px-20 py-2 bg-red-400 flex flex-col md:flex-row items-center md:justify-between shadow-md rounded-lg border hover:shadow-lg transition-shadow duration-300 relative">
        ...
        {/* Edit Icon in Circle */}
        <div onClick={() => setShowEditAdminModal(true)} className="absolute top-3 right-3 bg-blue-500 text-white p-2 rounded-full hover:bg-blue-600 transition-colors duration-200">
        ...
        {/* Centered Icon Links for Actions */}
          ...
          <div onClick={() => setShowAddTeacherModal(true)} className="flex w-48 h-48 flex-col items-center justify-center  bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-colors cursor-pointer duration-200">
          ...
          <div onClick={() => setShowRemoveTeacherModal(true)} className="flex w-48 h-48 flex-col items-center justify-center  bg-green-500 text-white rounded-full hover:bg-green-600 transition-colors cursor-pointer duration-200">
          ...
          <div onClick={() => setShowRemoveStudentModal(true)} className="flex w-48 h-48 flex-col items-center justify-center  bg-yellow-500 text-white rounded-full cursor-pointer hover:bg-yellow-600 transition-colors duration-200">
            <AiOutlineUserDelete className="w-28 h-28 mb-1" />
